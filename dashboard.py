...
var STRAT={
 ...
 dolrevmgr:{name:'DOL Reversal Manager Shadow',sub:'Fixed 2R control vs dedicated 58-feature DOL Reversal manager · SHADOW ONLY',tabs:[['live','Manager dashboard','/dol-reversal-manager','grid'],['data','Manager data','/dol-reversal-manager/data','file'],['status','Status','/dol-reversal-manager/status','grid']]},
