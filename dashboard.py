...
var STRAT={
 ...
 continuation:{name:'Continuation',sub:'HTF canonical baseline · frozen OPEN-DOL Policy B · independent forward shadow only',tabs:[['candidates','Candidates','/continuation/candidates','list'],['live','Dashboard','/continuation/dashboard','grid']]},
