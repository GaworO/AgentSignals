...
var STRAT={
 ...
 continuation:{name:'Continuation LONG + SHORT',sub:'Directional OPEN-DOL Policy B · LIVE przez Guard i account-specific TradersPost',tabs:[['dispatch','LIVE dispatch','/continuation/live/dashboard','grid'],['guard','Guard decisions','/guard','grid'],['candidates','Candidates','/continuation/candidates','list'],['trades','Filled trades','/continuation/candidates?execution=FILLED','book'],['shadow','Shadow dashboard','/continuation/dashboard','grid'],['pine','Pine · forward fills','/continuation/pine','file']]},
