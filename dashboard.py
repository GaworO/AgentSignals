...
var STRAT={
 ...
 dolrev:{name:'DOL Delivery Reversal',sub:'Delivered liquidity → causal Reversal → OPEN DOL · fixed 2R · forward shadow only',tabs:[['candidates','Candidates','/dol-delivery-reversal/candidates','list'],['trades','Trades','/dol-delivery-reversal/trades','book'],['successful','Successful Setups','/dol-delivery-reversal/successful','chart'],['pine','Pine · causal TV shadow','/dol-delivery-reversal/pine','file'],['data','Forward log','/dol-delivery-reversal/data','file']]},
 dolrevmgr:{name:'DOL Reversal Manager Shadow',sub:'Fixed 2R control vs dedicated 58-feature DOL Reversal manager · SHADOW ONLY',tabs:[['live','Live Shadow','/dol-reversal-manager','grid'],['trades','Trade History','/dol-reversal-manager/trades','file'],['replays','Real Trade Replays','/dol-reversal-manager/real-replays','file'],['metrics','Metrics','/dol-reversal-manager/metrics','grid']]},
 continuation:{name:'Continuation LONG + SHORT',sub:'LONG frozen baseline + exploratory SHORT · directional OPEN-DOL Policy B · forward shadow only',tabs:[['candidates','Candidates','/continuation/candidates','list'],['trades','Filled trades','/continuation/candidates?execution=FILLED','book'],['live','Dashboard','/continuation/dashboard','grid'],['pine','Pine · forward fills','/continuation/pine','file']]},
...
var NAV=[['General',[['gen/regime','Regime','regime'],['gen/monitor','Monitor','monitor']]],
         ...
         ['Strategies',[['dolrev','DOL Delivery Reversal · Shadow','target'],['continuation','Continuation','target'],['c','C','c'],['acba','A Continuation — Both Aligned','target'],['ab','A/B + Shallow · Legacy benchmark','ab']]],
         ['Context & Management',[['dol','Draw on Liquidity · Diagnostics','target'],['dolrevmgr','DOL Reversal Manager Shadow','grid'],['dmshadow','Downside Manager Shadow','grid']]],
