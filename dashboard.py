...
var STRAT={
 ...
 continuation:{name:'Continuation LONG + SHORT',sub:'LONG frozen baseline + exploratory SHORT · directional OPEN-DOL Policy B · forward shadow only',tabs:[['candidates','Candidates','/continuation/candidates','list'],['live','Dashboard','/continuation/dashboard','grid']]},
