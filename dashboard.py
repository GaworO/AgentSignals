...
var STRAT={
 ...
 dmshadow:{name:'Downside Manager Shadow',sub:'Fixed 2R control versus frozen downside policy · SHADOW ONLY — NO BROKER EXECUTION',tabs:[['live','Shadow summary','/downside-shadow','grid'],['status','Status JSON','/downside-shadow/status','file']]},
