...
class Config:
    ...
    retwin: int = 20           # window for the retrace back to the configured FVG hold depth
    ...
    rej_frac: float = 0.6      # canonical production body-hold depth from the FVG entry side; 0.5=legacy CE. env REJ_FRAC.
    ...
    def from_env(cls, env=None):
        ...
        return cls(
            ...
            rej_frac=float(e.get('REJ_FRAC', '0.6')),
