...
def render_page(trace: Iterable[Mapping[str, Any]], hours: float, env: Mapping[str, str] | None = None) -> str:
...
%s</body></html>""" % (len(candidates), ab_confirmed, shallow_ready, "".join(cards) if cards else empty)
